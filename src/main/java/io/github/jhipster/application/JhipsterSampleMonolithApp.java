...
public class JhipsterSampleMonolithApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterSampleMonolithApp.class);

    private final Environment env;

    public JhipsterSampleMonolithApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterSampleMonolith.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterSampleMonolithApp.class);
